    ...
    >
      <g>
        <path
          ...
          clipRule="evenodd"
          fill="#00ACD7"
          d="M141.6,255.4c-1.2,0-1.5-0.6-0.9-1.5l6.2-8c0.6-0.9,2.1-1.5,3.2-1.5h105.4c1.2,0,1.5,0.9,0.9,1.8l-5,7.7
        ...
        <path
          ...
          clipRule="evenodd"
          fill="#00ACD7"
          d="M97,282.6c-1.2,0-1.5-0.6-0.9-1.5l6.2-8c0.6-0.9,2.1-1.5,3.2-1.5h134.7c1.2,0,1.8,0.9,1.5,1.8l-2.4,7.1
        ...
        <path
          ...
          clipRule="evenodd"
          fill="#00ACD7"
          d="M168.5,309.8c-1.2,0-1.5-0.9-0.9-1.8l4.1-7.4c0.6-0.9,1.8-1.8,3-1.8h59.1c1.2,0,1.8,0.9,1.8,2.1l-0.6,7.1
        ...
        <g transform="translate(55)">
          <path
            ...
            clipRule="evenodd"
            fill="#00ACD7"
            d="M420.1,250.1c-18.6,4.7-31.3,8.3-49.6,13c-4.4,1.2-4.7,1.5-8.6-3c-4.4-5-7.7-8.3-13.9-11.2
          ...
          <path
            fill="#00ACD7"
            d="M517.8,413.4c-26.9-0.6-51.4-8.3-72.1-26c-17.4-15.1-28.4-34.3-31.9-57c-5.3-33.4,3.8-62.9,23.9-89.2
